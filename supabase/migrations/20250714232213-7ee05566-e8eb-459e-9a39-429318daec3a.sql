...
DECLARE
    ...
    staff_id UUID; -- Renamed to avoid confusion
...
BEGIN
    ...
    IF array_length(_provider_ids, 1) > 0 THEN
        FOREACH staff_id IN ARRAY _provider_ids LOOP
            ...
            RAISE NOTICE '[create_booking_atomic] STAFF AVAILABILITY UPDATED: staff_id=%, date=%, time=%', staff_id, _booking_date, _time_slot;
        END LOOP;
    END IF;
