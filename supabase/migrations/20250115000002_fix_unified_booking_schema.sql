-- Fix schema mismatch in create_unified_admin_booking
-- Remove extra_fee_reason from appointments INSERT and log separately
...
BEGIN
  ...
  -- Create appointment (FIXED: removed extra_fee_reason column)
