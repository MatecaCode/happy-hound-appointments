-- Fix create_booking_admin function to ensure proper client_id resolution
-- This migration addresses the "null value in column client_id" error

-- Update the create_booking_admin function with better error handling and validation
