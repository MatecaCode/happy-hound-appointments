-- Update create_booking_atomic function to accept calculated price and duration
...
BEGIN
    ...
    RAISE NOTICE '[create_booking_atomic] CALLED with params: user_id=%, pet_id=%, service_id=%, provider_ids=%, booking_date=%, time_slot=%, notes=%, calculated_price=%, calculated_duration=%', 
        _user_id, _pet_id, _service_id, _provider_ids, _booking_date, _time_slot, _notes, _calculated_price, _calculated_duration;
