-- Fix appointment_staff role constraint violation
-- Use service-based role derivation instead of generic 'assigned' role
...
BEGIN
  ...
  -- Appointment staff (FIXED: use constraint-compatible roles)
